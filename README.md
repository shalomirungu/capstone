...
## Data Preparation
During this process, we checked for null values, investigated the distribution of the Swahili news categories, label-encoded the categories, and separated numerical and categorical variables.
